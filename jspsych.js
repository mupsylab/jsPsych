...
class jsPsych {
    ...
    constructor(options) {
        ...
        // this.loadExtensionsSrc(options.extensions)
        // for (const extension of options.extensions) {
        //     this.extensions[extension.type] = new this.extensions[extension.type](this);
        // }
    }
    ...
    run(timeline) {
        ...
        this.prepareDom();
        this.checkExclusions(this.opts.exclusions);
        this.loadExtensions(this.opts.extensions);
    ...
    loadExtensions(extensions) {
        ...
        try {
            Promise.all(extensions.map((extension) => this.extensions[extension.type].initialize(extension.params || {})));
        }
        catch (error_message) {
