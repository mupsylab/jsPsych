...
jspsychPlugins["psychophysics"] = (function () {
  ...
  class PsychophysicsPlugin {
    ...
    create_simulation_data(trial, simulation_options) {
      ...
      if (trial.response_type == "button") {
        default_data = {
          ...
          key_press: this.jsPsych.randomization.randomInt(0, trial.choices.length - 1),
          response: this.jsPsych.randomization.randomInt(0, trial.choices.length - 1),
          avg_frame_time: 0,
          center_x: trial.centerX,
          center_y: trial.centerY,
          button_pressed: this.jsPsych.randomization.randomInt(0, trial.button_choices.length - 1),
        };
      } else if (trial.response_type == "mouse") {
        default_data = {
          rt: this.jsPsych.randomization.sampleExGaussian(500, 50, 1 / 150, true),
          ...
          center_x: trial.centerX,
          center_y: trial.centerY,
          click_x: this.jsPsych.randomization.sampleExGaussian(500, 50, 1 / 150, true),
          click_y: this.jsPsych.randomization.sampleExGaussian(500, 50, 1 / 150, true)
        };
      } else {
        default_data = {
          rt: this.jsPsych.randomization.sampleExGaussian(500, 50, 1 / 150, true),
    ...
    simulate_visual(trial, simulation_options, load_callback) {
      ...
      load_callback();
      if(trial.response_type == "button" || trial.response_type == "mouse") {
        if (data.rt !== null) {
